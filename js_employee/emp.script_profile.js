...
function togglePasswordVisibility() {
    ...
    if (passwordInput.type === "password") {
        ...
        passwordToggle.innerHTML = '<i class="bi bi-eye-fill" style="font-size: 16px"></i>';
    } else {
        passwordInput.type = "password";
        passwordToggle.innerHTML = '<i class="bi bi-eye-slash-fill" style="font-size: 16px"></i>';
...
changePassModal.addEventListener("hidden.bs.modal", function () {
    ...
    current_passwordToggle.innerHTML = '<i class="bi bi-eye-slash-fill" style="font-size: 16px"></i>';
    confirm_passwordToggle.innerHTML = '<i class="bi bi-eye-slash-fill" style="font-size: 16px"></i>';
...
function validateConfirm() {
    if (confirmPasswordInput.value.trim() === '') {
        ...
        confirmFeedback.textContent = 'Confirm New Password is required.';
        return false;
    } else {
        confirmPasswordInput.classList.remove('is-invalid');
        confirmFeedback.textContent = '';
...
saveChanges.addEventListener("click", function() {
    ...
    if (currentIsValid && newIsValid && confirmIsValid){
        if(checkPasswordMatch()){
            ...
            $.ajax({
                url: 'inc.employee_check_currentPassword.php',
                type: 'POST',
                ...
                success: function(response) {
                    ...
                    if (response === 'valid') {
                        ...
                        $.ajax({
                            url: 'inc.employee_updatePassword.php',
                            type: 'POST',
