...
$allowedPages = ['dashboard.php', 'departments.php', 'employees.php',
    'leave.php', 'timeOff.php', 'admins.php', 'new_employee.php', 'file_leave.php',
    'profile.php', 'credits.php', 'archived_departments.php', 'view_logs.php','archived_employees.php']; // List of allowed pages
...
<!-- CUSTOM CSS -->
<link rel="stylesheet" href="css/style_mylogs.css">
    ...
    <div class="body-container">
        <div class="button-container body-item">
            <div class="grid-item actions">
                ...
                <h3><a href="profile.php">Profile</a><i class="bi bi-chevron-right"></i><b style="color: var(--color-p3">View Logs</b> </h3>
            </div>
            <a href="profile.php">
...
<script src="js/script_mylogs.js"></script>
