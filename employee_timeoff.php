<?php
session_start();
$allowedPages = ['employee_dashboard.php', 'employee_profile.php', 'employee_history.php']; // List of allowed pages
...
<?php include_once "header_employee/emp.active_timeOff.php"; ?>
